...
<head>
    ...
    <title>ALADIN StoresS</title>
    <link rel="icon" href="../Infoproduct/logo.png" type="image/x-icon">
    <link rel="stylesheet" href="FashionFemale.css">
...
<body id="body">
    ...
    <header>
        ...
        <p style="width: 60%; font-size: 20px;">
            Tăng cường sức mạnh cho lịch trình năng động của bạn trong quần áo nữ của adidas. 
            Đồ thể thao có sứ mệnh hỗ trợ bạn vượt qua các buổi tập luyện khó khăn, còn quần áo mặc nhà ấm áp sẽ giúp bạn dễ dàng thư giãn.
        </p>
        <div class="Menubar">
            <ul>
                <li style="font-weight: bold;"><a href="FashionFemale.php">THỜI TRANG</a></li>
                <li><a href="">PHỤ KIỆN</a></li>
                <li><a href="">HÀNG MỚI</a></li>
                <li><a href="">TẤT CẢ CÁC SẢN PHẨM NỮ</a></li>
            </ul>
        </div>
    </header>
    <div class="container">
            ...
            <div class="myImage">
                <div style="position: relative;">
                    <img class="imgg"
                        ...
                        alt="Ảnh mặc định">
                    <p style="position: absolute;bottom: 20px;left: 5px;background-color: #fff;">800.000 <sup>đ</sup></p>
                </div>
                <div class="list-img" style="display: none;list-style: none;z-index: 999;">
                    <img class="img1"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/63f784dc05744c99a386af91001e1ae8_9366/Quan_Short_Block_adidas_Pro_Mau_xanh_da_troi_IL2246_21_model.jpg"
    ...
    <script>
        ...
        function text_animation() {
            let list = [
                ...
                "GIAO HÀNG MIỄN PHÍ CHO CÁC THÀNH VIÊN ALADIN"
            ];
            var i = 0;
