...
<head>
    ...
    <link rel="stylesheet" href="pageFemale.css">
    ...
    <header>
        <div class="Menu">
            <ul>
                ...
                <li><a href="ShoeFemale.php" target="_blank">GIÀY</a></li>
                <li><a href="FashionFemale.php" target="_blank">QUẦN ÁO</a></li>
                <li><a href="" target="_blank">PHỤ KIỆN</a></li>
                <li><a href="" target="_blank">HÀNG MỚI</a></li>
                <li><a href="" target="_blank">TẤT CẢ CÁC SẢN PHẨM NỮ </a></li>
            </ul>
        </div>
    ...
    <div class="Home">
        ...
        <div class="Homefirst">
            ...
            <div class="Homefirst_img3">
                ...
                <h3>The 2023 Collection</h3>
                <p>Chapter 03: Bộ sưu tập Adidas Basketball dành cho vận động viên hiện đại</p>
            </div>
            ...
            <div class="Homefirst_img5">
                <img src="https://brand.assets.adidas.com/image/upload/f_auto,q_auto,fl_lossy/if_w_gt_800,w_800/viVN/Images/Sportswear-FW23-ZNE-global-Sustain-GLP-Female-Teaser-Carousel-alternative-d_tcm337-1031930.jpg" alt="Ảnh nền">
                <h3>Z.N.E. adidas Sportswear. Bắt trọn khoảnh khắc</h3>
                <p>Tận hưởng cảm giác thoải mái suốt FIFA Women's World Cup™.</p>
            </div>
            <div class="Homefirst_img6">
                <img src="https://brand.assets.adidas.com/image/upload/f_auto,q_auto,fl_lossy/if_w_gt_800,w_800/viVN/Images/football-fw23-crazyfast-launch-glp-w-teaser-carousel-d_tcm337-1028968.jpg" alt="Ảnh nền">
                <h3>Crazyrush Pack</h3>
        ...
        <div class="Homeend">
            ...
            <p>
                Style is unique. On the pitch, in the gym, at home. It’s ours to define. adidas clothing and shoes don’t create our style.
                 We do. Find what represents you, complements you and helps you be your best self. Running shoes to go the extra mile. 
                 A pair of classic white trainers to match your favourite jeans. Tights that are squat proof and sports bras ready to move. 
                 Or simply the softest lounge wear for Sunday vibes. All the we need. All we want. More than we can dream of, in women’s apparel and footwear.
            </p>
        </div>
    </div>
