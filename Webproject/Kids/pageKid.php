...
<head>
    ...
    <link rel="stylesheet" href="pageKid.css">
...
<body id="body">
    ...
    <div>
        <div class="_video">
            <div class="fill_picture">
                <img src="https://brand.assets.adidas.com/image/upload/f_auto,q_auto,fl_lossy/if_w_gt_1920,w_1920/viVN/Images/Sportswear-FW23-ZNE-global-Launch-GLP-Kids-Masthead-d_tcm337-1021011.jpg" alt="">
            </div>
            <div class="intro">
                <div class="_wrap">
                    <div>
                        <h3 style="color: #f6f6f9;font-size: 40px">Z.N.E SPORTSWEAR</h3>
                        <p style="color: rgb(249, 247, 247);font-size: 18px;">Đắm chìm trong từng khoảnh khắc với Z.N.E</p>
                        <p style="color: rgb(255, 252, 252);font-size: 18px;">Dành cho thử thách mỗi ngày thi đấu.</p>
                        <div>
                            <div class="button">
                                <div class="_main_button">
    ...
    <div class="what">
        <div class="wrap">
            <div class="content">
                <a href="Fashionkid.php">
                    <div class="same">
                        <img src="https://brand.assets.adidas.com/image/upload/f_auto,q_auto,fl_lossy/if_w_gt_800,w_800/viVN/Images/SS18_YA_Infants_Q1_Ecomm_A-FC_Age_F_640x640_tcm337-244159.jpg"
                            alt="">
                        <p>Quần áo</p>
                        <h2>Mua Ngay</h2>
                    </div>
                ...
                <a href="Shoekid.php">
                    <div class="same">
                        <img src="https://assets.adidas.com/images/w_276,h_276,f_auto,q_auto,fl_lossy,c_fill,g_auto/629d526593ec49ad94510dc17cc4f7f3_9366/IG7177_01_standard.jpg"
                            alt="">
                        <p>Giày</p>
                        <h2>Mua Ngay</h2>
                    </div>
                </a>
                <a href="Sportskid.php">
                    <div class="same">
                        <img src="https://brand.assets.adidas.com/image/upload/f_auto,q_auto,fl_lossy/if_w_gt_800,w_800/viVN/Images/SS18_YA_LittleKids_Ecomm_A-FC_Age_F_640x640_tcm337-244165.jpg"
                            alt="">
                        <p>Thể Thao</p>
                        <h2>Mua Ngay</h2>
                    </div>
