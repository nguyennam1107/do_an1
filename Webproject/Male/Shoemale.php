...
<head>
    ...
    <link rel="stylesheet" href="Shoemal.css">
...
<body id="body">
                    ...
                    <li>
                        ...
                        <div class="sub_content">
                            <div class="content_link">
                                ...
                                <div class="content_2">
                                    <a href="Shoemale.php" class="a_hover"><b>GIÀY</b></a>
                                ...
                                <div class="content_2">
                                    <a href="Fashionmale.php" class="a_hover"><b>QUẦN ÁO</b></a>
    ...
    <header>
        <h1>GIÀY NAM </h1>
        <p style="width: 60%; font-size: 20px;">Dòng sản phẩm giày nam của adidas sẽ đáp ứng mọi nhu cầu, dù là bạn đang phấn đấu để trở thành người giỏi nhất hay chỉ muốn có một đôi giày vừa vặn nhất trong cuộc sống hàng ngày của mình. 
            Với thiết kế mang tính biểu tượng và công nghệ hiệu suất cao, bạn có thể chắc chắn rằng đôi giày của mình sẽ không khiến bạn thất vọng.</p>
        <div class="Menubar">
            <ul>
    ...
    <div class="container">
        ...
        <?php
            ...
            <div class="myImage row13">
                <div style="position: relative;">
                    <img class="imgg"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/489e312e1afd4689bb0bb4d987a78f52_9366/Giay_Solarboost_5_DJen_HP5664_HM3_hover.jpg"
                        alt="Ảnh mặc định">
                ...
                <div class="list-img" style="display: none;list-style: none;z-index: 999;">
                    <img class="img1"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/cd16ddc733aa4a378408afd200db5ecb_9366/Giay_Solarboost_5_trai_cam_GV9137_01_standard.jpg"
                        alt="">
                    <img style="padding: 0 5px 0 10px;" class="img2"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/cc34556d2e2742edbd67afc400f417e7_9366/Giay_Solarboost_5_trang_GW1962_01_standard.jpg"
                        alt="">
                    <img style="padding: 0 10px 0 5px;" class="img3"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/48d7c2167175433c92a2894ba67946be_9366/Giay_Solarboost_5_DJen_HP5664_HM1.jpg"
                        alt="">
                    
                </div>
                <p>Giày SolarBoost 5 <br><span style="color: #868687;">Nam Chạy</span><br><span
            ...
            <div class="myImage row14">
                <div style="position: relative;">
                    <img class="imgg"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/eb0b9557873344559e74a33c60f36353_9366/Giay_Chay_Bo_Supernova_3_trang_IE4366_HM1.jpg"
                        alt="Ảnh mặc định">
                    <p style="position: absolute;bottom: 20px;left: 5px;background-color: #fff;">3.000.000 <sup>đ</sup></p>
                </div>
                <div class="list-img" style="display: none;list-style: none;z-index: 999;">
                    <img class="img1"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/e8d33874b9d149f6b345d938877059c4_9366/Giay_Chay_Bo_Supernova_3_trang_HQ1806_HM1.jpg"
                        alt="">
                    <img style="padding: 0 5px 0 10px;" class="img2"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/b276123a9bba4fa28d3b0a9f21e2a7cc_9366/Giay_Chay_Bo_Supernova_3_Mau_xanh_da_troi_IE4359_01_standard.jpg"
                        alt="">
                    <img style="padding: 0 10px 0 5px;" class="img3"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/7bf80037e3a644f693a4fd5e04094429_9366/Giay_Chay_Bo_Supernova_3_Xam_IE4365_HM1.jpg"
                        alt="">
                    <img class="img4"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/eb0b9557873344559e74a33c60f36353_9366/Giay_Chay_Bo_Supernova_3_trang_IE4366_HM1.jpg"
                        alt="">
                </div>
                <p>Giày chạy bộ SUPERNOVA 3<br><span style="color: #868687;">Nam Chạy</span><br><span
        ...
        <div class="row row2">
            <div class="myImage row21">
                <div style="position: relative;">
                    <img class="imgg"
                        src="https://assets.adidas.com/images/w_383,h_383,f_auto,q_auto,fl_lossy,c_fill,g_auto/7f35aa7ca8f649b38a5330e5e3dd4b17_9366/gi%C3%A0y-adizero-boston-12.jpg"
                        alt="Ảnh mặc định">
                    <p style="position: absolute;bottom: 20px;left: 5px;background-color: #fff;">3.000.000 <sup>đ</sup></p>
                </div>
                <div class="list-img" style="display: none;list-style: none;z-index: 999;">
                    <img class="img1"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/d9be7869e7444cebbcb1907eaf593f8d_9366/Giay_Adizero_Boston_12_trang_HP9705_01_standard.jpg"
                        alt="">
                    <img style="padding: 0 5px 0 10px;" class="img2"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/d199e1bc183b4286914df87bcccc428e_9366/Giay_Adizero_Boston_12_Mau_xanh_da_troi_ID4233_01_standard.jpg"
                        alt="">
                    <img style="padding: 0 10px 0 5px;" class="img3"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/89c0a21c89a249598f0d22e7d0160d92_9366/Giay_Adizero_Boston_12_Mau_xanh_da_troi_IF8173_HM1.jpg"
                        alt="">
                    <img class="img4"
                        src="https://assets.adidas.com/images/w_383,h_383,f_auto,q_auto,fl_lossy,c_fill,g_auto/7f35aa7ca8f649b38a5330e5e3dd4b17_9366/gi%C3%A0y-adizero-boston-12.jpg"
                        alt="">
                </div>
                <p>Giày Adizero Boston 12<br><span style="color: #868687;">Nam Chạy</span><br><span
                        style="color: #868687;">4 colours</span>&nbsp;• mới</p>
            </div> 
            ...
            <div class="myImage row22">
                ...
                <div class="list-img" style="display: none;list-style: none;z-index: 999;">
                    <img class="img1"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/626aefae60f647a496e6aef900bab3bf_9366/ADIZERO_SL_trang_GV9095_01_standard.jpg"
                        alt="">
                    <img style="padding: 0 5px 0 10px;" class="img2"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/96fa7303d14249b7af33af9c00a79c5c_9366/ADIZERO_SL_trai_cam_GX9775_01_standard.jpg"
                        alt="">
                    <img style="padding: 0 10px 0 5px;" class="img3"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/b5a48de3c4684d6c8e38af8d0085929b_9366/ADIZERO_SL_trang_GY2589_01_standard.jpg"
                        alt="">
                    <img class="img4"
                        src="https://assets.adidas.com/images/w_766,h_766,f_auto,q_auto,fl_lossy,c_fill,g_auto/ef76174079d24f7dabb7b9e99b028da1_9366/adizero-sl.jpg"
                        alt="">
                ...
                <p> Giày Adizero SL<br><span style="color: #868687;">Nam Originals</span><br><span
            ...
            <div class="myImage row23">
                <div style="position: relative;">
                    <img class="imgg"
                        src="https://assets.adidas.com/images/w_766,h_766,f_auto,q_auto,fl_lossy,c_fill,g_auto/8061bd4cb1f44d4094023e4250984d00_9366/gi%C3%A0y-nmd_s1.jpg"
                        alt="Ảnh mặc định">
                    <p style="position: absolute;bottom: 20px;left: 5px;background-color: #fff;">4.000.000 <sup>đ</sup></p>
                </div>
                <div class="list-img" style="display: none;list-style: none;z-index: 999;">
                    <img class="img1"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/923dfe18844845be85173663fccd9ef6_9366/Giay_NMD_S1_mau_xanh_la_IE2075_01_standard.jpg"
                        alt="">
                    <img style="padding: 0 5px 0 10px;" class="img2"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/fe6e39055d4c440db883f30055a536a7_9366/Giay_NMD_S1_DJen_IG5537_01_standard.jpg"
                        alt="">
                    <img style="padding: 0 10px 0 5px;" class="img3"
                        src="https://assets.adidas.com/images/w_766,h_766,f_auto,q_auto,fl_lossy,c_fill,g_auto/8061bd4cb1f44d4094023e4250984d00_9366/gi%C3%A0y-nmd_s1.jpg"
                        alt="">
                ...
                <p>Giày NMD_S1<br><span style="color: #868687;">Nam Originals</span><br><span
                        style="color: #868687;">3 colours</span>&nbsp;• mới</p>
            </div> 
            ...
            <div class="myImage row24">
                <div style="position: relative;">
                    <img class="imgg"
                        src="https://assets.adidas.com/images/w_766,h_766,f_auto,q_auto,fl_lossy,c_fill,g_auto/b5c21c54bbb740bf892ea74b0f876b05_9366/gi%C3%A0y-nmd_g1.jpg"
                        alt="Ảnh mặc định">
                    <p style="position: absolute;bottom: 20px;left: 5px;background-color: #fff;">4.000.000 <sup>đ</sup></p>
                </div>
                <p>Giày NMD_G1 <br><span style="opacity: 30%;">Nam Originals</span><br> mới</p>
            </div>
        ...
        <div class="row row3">
            ...
            <div class="myImage row31">
                <div style="position: relative;">
                    <img class="imgg"
                        src="https://assets.adidas.com/images/w_766,h_766,f_auto,q_auto,fl_lossy,c_fill,g_auto/f34034686f3e4970b7212c9753ee790d_9366/gi%C3%A0y-adizero-adios-pro-3-m.jpg"
                        alt="Ảnh mặc định">
                    <p style="position: absolute;bottom: 20px;left: 5px;background-color: #fff;">6.000.000 <sup>đ</sup></p>
                </div>
                <div class="list-img" style="display: none;list-style: none;z-index: 999;">
                    <img class="img1"
                        src="https://assets.adidas.com/images/w_766,h_766,f_auto,q_auto,fl_lossy,c_fill,g_auto/f34034686f3e4970b7212c9753ee790d_9366/gi%C3%A0y-adizero-adios-pro-3-m.jpg"
                        alt="">
                    <img style="padding: 0 5px 0 10px;" class="img2"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/b653adb58ab542b9bdcb928b2a9a4b28_9366/GIAY_ADIZERO_ADIOS_PRO_3_M_Mau_xanh_da_troi_IG3132_HM1.jpg"
                        alt="">
                    
                </div>
                <p>Giày ADIZERO ADIOS PRO 3 M<br><span style="color: #868687;">Nam Chạy</span><br><span
        ...
        <div class="row row4">
            ...
            <div class="myImage row43">
                <div style="position: relative;">
                    <img class="imgg"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/62f845df975a40158d6baf460168b8d4_9366/Giay_Tennis_Gamecourt_2.0_trang_HQ8476_01_standard.jpg"
                        alt="Ảnh mặc định">
                    <p style="position: absolute;bottom: 20px;left: 5px;background-color: #fff;">1.000.000 <sup>đ</sup></p>
                </div>
                <div class="list-img" style="display: none;list-style: none;z-index: 999;">
                    <img class="img1"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/682c662f24a34582af0eaf690137db22_9366/Giay_Tennis_Gamecourt_2.0_DJen_HQ8478_01_standard.jpg"
                        alt="">
                    <img style="padding: 0 5px 0 10px;" class="img2"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/73b2a96412574daeab730e43611480f3_9366/Giay_Tennis_Gamecourt_2.0_Ngoc_lam_IG9566_01_standard.jpg"
                        alt="">
                    <img style="padding: 0 5px 0 10px;" class="img3"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/c3250067df644209a54da9b49206d006_9366/Giay_Tennis_Gamecourt_2.0_DJen_IG9567_01_standard.jpg"
                        alt="">
                    <img style="padding: 0 5px 0 10px;" class="img4"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/62f845df975a40158d6baf460168b8d4_9366/Giay_Tennis_Gamecourt_2.0_trang_HQ8476_01_standard.jpg"
                        alt="">
                </div>
                <p> Giày Tennis Gamecourt 2.0 <br><span style="color: #868687;">Nam Quần Vợt</span><br><span
                        style="color: #868687;">4 colours</span>&nbsp;• mới</p>
            </div>
        ...
        <div class="row row5">
            <div class="myImage row51">
                <div style="position: relative;">
                    <img class="imgg"
                        src="https://assets.adidas.com/images/w_766,h_766,f_auto,q_auto,fl_lossy,c_fill,g_auto/86ecb2a16e1b44989f1e3da868927a23_9366/gi%C3%A0y-trainer-rapiadmove-adv.jpg"
                        alt="Ảnh mặc định">
                    <p style="position: absolute;bottom: 20px;left: 5px;background-color: #fff;">1.000.000 <sup>đ</sup></p>
                </div>
                <div class="list-img" style="display: none;list-style: none;z-index: 999;">
                    <img class="img1"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/54b2ad6b499b4c59867a4643b5d1a38c_9366/Giay_Trainer_Rapiadmove_ADV_DJen_HP3265_01_standard.jpg"
                        alt="">
                    <img style="padding: 0 5px 0 10px;" class="img2"
                        src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/00f240e3d1bd46e7998c38ec64044e8a_9366/Giay_Trainer_Rapiadmove_ADV_mau_xanh_la_HP3268_01_standard.jpg"
                        alt="">
                ...
                <p> Giày Trainer Rapiadmove ADV <br><span style="color: #868687;">Nam Tập Luyện</span><br><span
                        style="color: #868687;">3 colours</span>&nbsp;• mới</p>
            </div>
