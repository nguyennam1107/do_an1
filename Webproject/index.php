...
if ($conn->connect_error) {
    ...
    echo '<li><span>Xin chào, ' . $username . '</span></li>';
...
<body class="body">
    ...
    <header class="title">
        <div class="text_animation">
            <p style="cursor: pointer;">GIAO HÀNG MIỄN PHÍ CHO CÁC THÀNH VIÊN CỦA Nhóm 2 DHTI15A21&nbsp&nbsp<i
        ...
        <div class="navbar">
            <a href="index.php">
                <div class="logo">
                    <div class="_logo">
                        <img src="../Webproject/database/logo/ALADIN.png"
                            alt="">
                    </div>  
                </div>
            </a>
            ...
            <div class="search_help">
                <div class="help">
                    <ul class="help_ul">
                        ...
                        <?php if(isset($_SESSION['ID'])) {displayLoginOrLogoutLink();}else {
                        echo '<li><a href="./Login/Login.php">Đăng ký hội viên</a></li>';
                         } ?>
                ...
                <div class="search">
                    ...
                    <?php if(isset($_SESSION['ID'])) {echo '<a href="./cart.php"><i class="fa-solid fa-bag-shopping"></i></a>';}else {
                        echo '<a href="./Login/Login.php"><i class="fa-solid fa-bag-shopping"></i></a>';
                     } ?>
                </div>
            </div>
        </div>
            ...
            <?php
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<p>' . number_format($row['Gia']) . '<sup>$</sup></p>';
                        echo '</div>';
                        echo '<div class="cost">';
                        echo '<h3>' . $row['Tensanpham'] . '</h3>';
                        echo '<p>' . $row["NhaSanXuat"] . '</p>';
                        echo '<p>'  . $row["Soluong"] .'</p>';
                        echo '<p>'  . $row["Size"] .'</p>';
                        echo '</div>';
                        echo '<div class="_border"></div>';
                        echo '</div>';
                        echo '</a>';
                    }
                } else {
